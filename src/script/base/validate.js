 ...
 */
export function addInputError(el, title) {
 ...
 * @author pthieu (09-07-2021)
 */
export function validateEmpty(el, msg = false) {
 ...
 * @author pthieu (09-07-2021)
 */
export function validateFormat(el, validateObj, msg = false) {
 ...
 * @author pthieu (09-07-2021)
 */
export function validateCombobox(el, msg = false) {
 ...
 * @author pthieu (09-07-2021)
 */
export function addNoticeToInput(el, msg) {
