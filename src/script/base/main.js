...
export class PopUp {
  ...
  static add(type, popupObject) {
    var iconClose = require("../../assets/icon/x.svg");
    var iconPopUp;
    var popup = $(`
    <div class="popup">
    ...
    switch (type) {
      case "danger":
        iconPopUp = require("../../assets/icon/alarm.png");
        $(popup).find(".popup-icon img").attr("src", iconPopUp);
      ...
      case "warning":
        iconPopUp = require("../../assets/icon/warning.png");
        $(popup).find(".popup-icon img").attr("src", iconPopUp);
        $(popup).find(".popup-footer").append(`
          <button type="button" class="m-btn-default m-btn-cancel">${popupObject.btnTextCancel}</button>
